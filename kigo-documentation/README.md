...
**Java Libraries:**
Use an IDE such as Eclipse for better project management. When working with the kigokelly and kigonoah libraries, ensure you create or import them as Maven projects in Eclipse.
...
Add any dependencies for API's into pom.xml file.
Refer to documentation from API's creator.
Add feature to upload playlists.
